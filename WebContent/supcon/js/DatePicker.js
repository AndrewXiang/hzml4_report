 ...
 * @modified by jiangfeng 2012-09-27
*/
...
function setyear(inputObj,dateFormatStyle,beginDate,endDate,lang){
	if(null == inputObj){return null;}
	new Calendar(inputObj,dateFormatStyle,beginDate,endDate,lang,"yy").show();
	//new Calendar(inputObj,dateFormatStyle,beginDate,endDate,1,"m").show();
}
...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar .year li{float:left;width:33.3%;height:20px;line-height:20px;text-align:center;background-color:#EDF3F9;}";
...
Calendar.language = {
	...
	"clear":[["Clear"], ["清空"]],
	"today":[["Today","Current","This Year"], ["今天","当月","今年"]],
	"close":[["Close"], ["关闭"]]  
};
...
Calendar.prototype.draw = function() {   
  ...
  if("d" == this.type){
	...
	if("m" == this.type){
		...
		lis += "<li id='NextYear' class='mark' style='width:12%;' title='Next Year'>&raquo;</li></ul></div>";
		lis += "<div class='calendarBody'>";
		lis += "</ul><ul class='year' id='thisMonth'>";
		for(var i=-1; i<=1; i++){
			var currentDate = ((this.year+i) + "-01").toDate("yyyy-MM");
			if(currentDate < this.beginDate || currentDate > this.endDate){
				lis += "<li class='lastMonthDate'>" + (this.year+i) + "</li>";
				continue;
			}
			lis += "<li class='thisMonth' title='" + (this.year+i) + "-01" + "-01'><a href='javascript:void(0);'";
			if(((this.year+i)+"-01") == (this.date).format("yyyy-MM")){
				lis += " class='today' ";
			}
		...
		lis += "<div class='calendarBottom'><ul>";
		lis += "<li id='emptyCalendar' style='width:27%;' title='Clear'>" + Calendar.language.clear[this.lang] +"</li>";
		lis += "<li id='selectCurrent' style='width:45%;' title='This Year'>" + Calendar.language.today[this.lang][2] +"</li>";
	}
  }
